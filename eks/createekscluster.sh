...
REGION=us-east-2
STACK_NAME=zep-flink-eks-stack1
...
if ! aws cloudformation describe-stacks --region $REGION --stack-name $STACK_NAME ; then
    ...
    --template-body file://zep-flink-eks.yaml \
    --capabilities CAPABILITY_IAM \
    --parameters \
      ParameterKey=ParentVPCStack,ParameterValue='zep-flink-vpc-stack1' \
      ParameterKey=ClusterName,ParameterValue='zep-flink-on-aws'
